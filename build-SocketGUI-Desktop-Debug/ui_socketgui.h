...
public:
    ...
    QListWidget *listReceivedMessages;
    ...
    void setupUi(QMainWindow *SocketGUI)
    {
        ...
        listReceivedMessages = new QListWidget(frame_2);
        listReceivedMessages->setObjectName(QStringLiteral("listReceivedMessages"));

        verticalLayout->addWidget(listReceivedMessages);
        ...
        portLabel->setBuddy(portReceiveOn);
        label->setBuddy(ipReceiveOn);
        iPAddressLabel_2->setBuddy(ipRemoteSendTo);
        portLabel_2->setBuddy(portRemoteSendTo);
#endif // QT_NO_SHORTCUT
        QWidget::setTabOrder(ipReceiveOn, portReceiveOn);
        QWidget::setTabOrder(portReceiveOn, ipRemoteSendTo);
        QWidget::setTabOrder(ipRemoteSendTo, portRemoteSendTo);
        QWidget::setTabOrder(portRemoteSendTo, buttonServerListen);
        QWidget::setTabOrder(buttonServerListen, textEditSend);
        QWidget::setTabOrder(textEditSend, buttonSend);
        QWidget::setTabOrder(buttonSend, listReceivedMessages);
        QWidget::setTabOrder(listReceivedMessages, buttonClear);
